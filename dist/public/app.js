...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (orderForm) {
    orderForm.addEventListener('submit', (e) => {
      e.preventDefault();
      alert('Thank you! Your documents have been submitted. An Salt Lake City Auto Appraisers specialist will review your materials and follow up with you promptly.');
      orderForm.reset();
    });
  }
